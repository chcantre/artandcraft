...
if (!$connection) {
    ...
    $lname = $_POST['lname'];
    echo "<h1>Vendor $lname Info</h1>$rtlf";
    $query = "SELECT vendor_id, zone, location, fname, lname, street1, street2, city, state, zip, phone1, mobile1, phone2, mobile2, email, category, addlinfo, electric, wall, tabletype, imagerelease, facebook, website, year, accepted, requests FROM Vendors WHERE lname = '$lname'";
    ...
    if ($retval) {
        ...
        echo "<p>That vendor name was not found.</p>";
    }
    echo $ender;
